...
import "./BaseItemUri.sol";

contract UniqueTrophy is BaseItemUri, ERC5633 {
    uint256 public totalItems;

    constructor(string memory _uri) BaseItemUri(_uri) {
        totalItems = 0;
    }

    // Override mint from ISpaceItem
    function mint(address account, uint256, uint256)
        public
        override(BaseItemUri)
